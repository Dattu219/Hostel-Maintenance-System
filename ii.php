    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">Item Issue</a></li>
            ...
            <div class="container">
                <div class="row row-header">
                    <div class="col-12 col-sm-12">
                        <h1>Item Issue Report</h1>
                        <p>You can view item issue report and piechart representing item issue report</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                ...
                echo "<tr><th>Item Name</th><th>Issued Quantity</th><th>Issued Cost</th></tr>";
                $labels=array();
                $data=array();
                for($i=2;$i<=$row;$i++){
                    echo "<tr>";
                    array_push($labels,$sheet->getCell('B'.$i)->getValue());
                    array_push($data,$sheet->getCell('F'.$i)->getValue());
                    echo "<td>".$sheet->getCell('B'.$i)->getValue()."</td>";
                    echo "<td>".$sheet->getCell('I'.$i)->getValue()."</td>";
                    echo "<td>".$sheet->getCell('F'.$i)->getValue()."</td>";
                    echo "<tr>";
                }
                ?></table>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                const config = {
                    ...
                    options: {
                        ...
                        title: {
                            display: true,
                            text: "Piechart representing item issues"
                        }
                        },
                    },
                };
