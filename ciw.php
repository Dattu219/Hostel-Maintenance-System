...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">Consolidated Item Wastage</a></li>
                                <li>
            ...
            <div class="container">
                <div class="row row-header">
                    <div class="col-12 col-sm-12">
                        <h1>Consolidated Item Wastage</h1>
                        <p>You can entry/edit consolidated wastage of items</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <nav class="navbar navbar-dark navbar-expand-lg d-flex justify-content-between" id="menu">
            ...
            if($qnt1!=0){
                echo "<td><input type='number' name='qnt' min='1' max=$qnt1 step='0.01' value='0'></input></td>";
            ...
            if(isset($_POST[$sub1])){
                if($_SESSION['date']!=''){
                    ...
                    $cost=$sheet->getCell('E'.$i)->getValue();
                    $sheet->setCellValue('C'.$i,$qnt1-$qnt);
                    $cost1=$sheet->getCell('G'.$i)->getValue();
                    $c=($qnt*$cost);
                    $sheet->setCellValue('G'.$i,$c+$cost1);
                    $qnt1=$sheet->getCell('J'.$i)->getValue();
                    $sheet->setCellValue('J'.$i,$qnt+$qnt1);
                ...
                if($_SESSION['date']!=''){
                    ...
                    if($numrows==0){
                        mysqli_query($con,"INSERT INTO $table ("."date,"."item,"."wastage) VALUES ('".$date."','".$item."','".$c."')");
                    }
                    else{
                        while($row=mysqli_fetch_assoc($query)){
                        $wastage=$row['wastage'];
                        mysqli_query($con,"UPDATE $table SET wastage='".$wastage+$c."' WHERE date='".$date."' AND item='".$item."'");
                        }
                    }
                }
            }
