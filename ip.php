    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="#">Item Purchase</a></li>
            ...
            <div class="container">
                <div class="row row-header">
                    <div class="col-12 col-sm-12">
                        <h1>Item Purchase Report</h1>
                        <p>You can view item purchase report and piechart representing item purchase report</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                ...
                echo "<tr><th>Item Name</th><th>Purchased Quantity</th><th>Purchased Cost</th></tr>";
                $labels=array();
                $data=array();
                for($i=2;$i<=$row;$i++){
                    echo "<tr>";
                    array_push($labels,$sheet->getCell('B'.$i)->getValue());
                    array_push($data,$sheet->getCell('D'.$i)->getValue());
                    echo "<td>".$sheet->getCell('B'.$i)->getValue()."</td>";
                    echo "<td>".$sheet->getCell('H'.$i)->getValue()."</td>";
                    echo "<td>".$sheet->getCell('D'.$i)->getValue()."</td>";
                    echo "<tr>";
                }
                ?></table>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                const config = {
                    ...
                    options: {
                        ...
                        title: {
                            display: true,
                            text: "Piechart representing item purchases"
                        }
                        },
                    },
                };
